// Servidor HTTP (jogo neon-kick.html + estaticos) + WebSocket multiplayer.
// Um unico processo Node serve o jogo e roda as salas autoritativas, permitindo
// hospedar tudo num unico deploy (ex.: Render).
...
import { MODES } from "./multiplayer/shared/constants.js";
import { C2S, S2C, encode, decode } from "./multiplayer/shared/protocol.js";
import { Room } from "./multiplayer/server/room.js";

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const PORT = process.env.PORT || 8080;

// ───────────────────────────── HTTP estatico ────────────────────────────────
// Usamos um handler HTTP puro (sem express) para servir dallo do jogo e os
// endpoints de salas num unico http.Server — o mesmo que o WebSocket escuta.
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === "/") pathname = "/neon-kick.html";
